...
export default function Contacts() {
  usePageMeta({
    ...
    description: "Детский центр «Рыбка Долли» в Керчи — ул. Циолковского, 12. Телефон: +7 (988) 152-16-98. Режим работы: пн–пт 8:00–18:00. Занятия для детей от 2 лет: развитие, английский, логопед, продлёнка. Первое занятие бесплатно — запишитесь прямо сейчас!",

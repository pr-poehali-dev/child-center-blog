    ...
    <>
      ...
      <section className="bg-white py-16 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-4">
          <SectionTitle overline="чем живёт центр" title="О центре коротко" />
          <h2 className="sr-only">Детский центр «Рыбка Долли» в Керчи — всё для развития вашего ребёнка</h2>
          <div className="grid md:grid-cols-2 gap-5">
            {[
              { title: "Занятия для детей", text: "Проводим развивающие занятия для детей от 2 до 10 лет в мини-группах. Занятия для дошкольников 3, 4, 5 и 6 лет с опытными педагогами. Индивидуальный подход к каждому ребёнку, комфортные условия, маленькие группы. Раннее развитие малышей через игру." },
              { title: "Логопед и развитие речи", text: "Детский логопед — постановка звуков, коррекция речи, запуск речи у малышей. Занятия с логопедом индивидуально и в мини-группах. Логопедические занятия для дошкольников с результатом. Развитие речи дети — наша специализация." },
              { title: "Подготовка к школе", text: "Курс подготовки к школе для дошкольников в Керчи. Обучение чтению по слогам, письму, счёту. Будущий первоклассник будет готов: развитие внимания, памяти, логики и мышления. Подготовка к школе в мини-группах и индивидуально." },
              { title: "Английский язык для детей", text: "Английский для детей с 4 лет через игру в Керчи. Курсы английского для дошкольников и школьников в группах и индивидуально. Разговорный английский, обучение с нуля. Английский для малышей — игровой формат занятий." },
              { title: "Группа продлённого дня", text: "Частная продлёнка в Керчи — присмотр за детьми после школы. Помощь с домашними заданиями, развивающие занятия, питание. Продлёнка полный день и полдня. Безопасные условия, опытные педагоги." },
              { title: "Летний клуб и кружки", text: "Летний дневной лагерь для детей в Керчи — насыщенная программа, творчество и игры. Кружки для детей, развивашки дошкольникам, детские кружки по интересам. Центр раннего развития — куда отдать ребёнка от 2 до 10 лет." },
            ].map((item) => (
              <div
                key={item.title}
                className="relative"
                style={{
                  ...
                  borderRadius: 16,
                  padding: "24px 22px",
                  boxShadow: "0 2px 5px rgba(0,0,0,0.04), 0 10px 20px rgba(0,0,0,0.05)",
                }}
              >
                <img src={honeyStar} alt="" className="absolute" style={{ width: 18, height: 18, top: 14, left: 14, opacity: 0.9 }} />
                <h3 className="font-playfair font-bold pl-7" style={{ color: "#17364A", fontSize: 19 }}>{item.title}</h3>
                <p className="font-golos text-gray-600 mt-2" style={{ fontSize: 14.5, lineHeight: 1.6 }}>{item.text}</p>
              </div>
            ))}
          </div>
          <p className="font-golos text-xs text-gray-400 mt-8 text-center">

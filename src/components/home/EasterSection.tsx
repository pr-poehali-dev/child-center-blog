...
const EASTER_POSTS = [
  ...
  { id: 33, title: "Космические пончики ⭐", desc: "Яркие, необычные, праздничные — пончики, которые поднимут настроение всей семье", emoji: "🍩", color: "#f0f9ff", border: "#bae6fd", tag: "#0284c7" },
  { id: 39, title: "Как успокоить истерику ребенка?", desc: "Праздники бывают эмоциональными. Советы педагога на случай, если что-то пошло не так", emoji: "🤗", color: "#f0fdf4", border: "#bbf7d0", tag: "#16a34a" },
];
